...
export class ProductoPedidoController {
  ...
  async find(
    ...
    return this.productoRepository.elPedido(id).find(filter);
  }
  ...
  async create(
    ...
    return this.productoRepository.elPedido(id).create(pedido);
  }
  ...
  async patch(
    ...
    return this.productoRepository.elPedido(id).patch(pedido, where);
  }
  ...
  async delete(
    ...
    return this.productoRepository.elPedido(id).delete(where);
  }
}
